        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ul className="space-y-4">
            {service.features.map((feature) => (
              <li key={feature} className="flex gap-3 items-start bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                <span className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold mt-0.5" style={{ background: "#6FFF2C", color: "#111827" }}>✓</span>
      ...
      <section className="py-16 px-6 bg-gray-900">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { color: "#14EEEE", title: "100% Legal Focus", body: "We work exclusively with law firms. Every tactic is built for the legal market specifically." },
              { color: "#6FFF2C", title: "Transparent Pricing", body: "Our pricing is on the website. No discovery calls required to learn what anything costs." },
              { color: "#14EEEE", title: "Month-to-Month", body: "No long-term contracts. We earn your business every single month." },
            ].map((item) => (
