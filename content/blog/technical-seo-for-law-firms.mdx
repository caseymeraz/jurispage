...
FID (First Input Delay) is dead. Google replaced it with INP (Interaction to Next Paint) as an official Core Web Vital. The difference matters: FID only measured the delay of the *first* interaction. INP measures *every* interaction throughout the entire page session and reports the worst one.
