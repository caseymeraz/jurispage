...
export async function POST(req: NextRequest) {
  try {
    ...
    const attorneyDisplay = attorneys > 10 ? "11+" : attorneys <= 2 ? "1–2" : attorneys;
      ...
      ? `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="padding: 32px; background: #ffffff;">
            ...
            <p style="color: #555; line-height: 1.7;">Thanks for reaching out. With ${attorneys}+ attorneys, your firm is beyond our standard Launchpad pricing — which means you deserve a custom strategy built around your specific market and goals, not a one-size-fits-all package.</p>
            <p style="color: #555; line-height: 1.7;">One of our legal marketing specialists will reach out within one business day to discuss your situation and build a proposal that fits your firm.</p>
