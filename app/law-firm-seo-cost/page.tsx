...
const faqs = [
  ...
  { question: "Is there a setup fee for law firm SEO?", answer: "Many agencies charge a one-time setup fee (often thousands) that covers the initial audit, keyword research, and onboarding. At JurisPage, our Launchpad plan charges no upfront setup fee. Costs are spread across a 24-month engagement so small and startup firms can afford the work without a large day-one check. Launchpad starts at $2,000/month for small or startup firms with little to no online presence. For established firms, Juris Digital (jurisdigital.com) provides full-service engagements running $5,000 to $50,000+/month with no upfront setup fees." },
