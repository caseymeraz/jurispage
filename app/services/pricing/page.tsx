...
export const metadata: Metadata = {
  ...
  description: "Custom law firm marketing plans starting at $2,000/month. No long-term contracts, no hidden fees, no guessing games. Contact us for a personalized quote.",
...
const faqSchema = {
  ...
  "@type": "FAQPage",
  mainEntity: [
    { "@type": "Question", name: "What's included in each plan?", acceptedAnswer: { "@type": "Answer", text: "Launchpad covers everything a new firm needs to get online: a WordPress website live in 30 days, Google Business Profile setup, local SEO foundation, citation building, and branded email. Grow adds a full SEO campaign plus your choice of Google Ads management or a website redesign, monthly reporting, and ongoing GBP optimization. Dominate is full-service: SEO + Google Ads + content writing + GEO optimization, with bi-weekly strategy calls and a dedicated account team. Contact us for pricing on each plan." } },
    ...
    { "@type": "Question", name: "Is there a setup fee?", acceptedAnswer: { "@type": "Answer", text: "Setup costs vary by plan. We're upfront about all costs during your first conversation — no surprises. Contact us for a full breakdown." } },
  ],
};
...
const serviceSchema = {
  ...
  hasOfferCatalog: {
    ...
    itemListElement: [
      { "@type": "Offer", name: "Launchpad", description: "Website, local SEO foundation, and Google Business Profile setup for new law firms." },
      { "@type": "Offer", name: "Grow", description: "SEO campaign plus Google Ads or website redesign for established firms." },
      { "@type": "Offer", name: "Dominate", description: "Full-service SEO, Google Ads, content writing, and GEO optimization." },
    ],
  },
};

const faqs = [
  { question: "What's included in each plan?", answer: "Launchpad covers everything a new firm needs to get online: WordPress website live in 30 days, Google Business Profile setup, local SEO foundation, citation building, and branded email. Grow adds a full SEO campaign plus your choice of Google Ads management or a website redesign, monthly reporting, and ongoing GBP optimization. Dominate is full-service: SEO, Google Ads, content writing, and GEO optimization (AI search visibility), with bi-weekly strategy calls and a dedicated account team. Contact us for pricing on the plan that fits your firm." },
  ...
  { question: "Is there a setup fee?", answer: "Setup costs vary by plan. We'll give you a straight breakdown during your first conversation — no surprises, no hidden charges. Contact us to discuss what's included for your specific situation." },
];
...
const plans = [
  {
    ...
    sub: "Contact us for a custom quote",
    ...
    <>
      ...
      <section className="py-20 px-6 text-center bg-white border-b border-gray-100">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 text-lg">Plans starting at $2,000/month. Month-to-month. Results in 90 days or we work for free.</p>
        </div>
      </section>
      ...
      <section className="py-6 px-6 border-b border-gray-100 bg-gray-50">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {[
            ...
            { val: "No Hidden Fees", sub: "Starting at $2,000/month" },
          ].map((item) => (
            <div key={item.val}>
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 text-sm mt-3 max-w-xl mx-auto">Plans start at $2,000/month. Pricing is customized based on your firm&apos;s market, practice area, and goals. <Link href="/contact/" className="underline" style={{ color: "#EE6C13" }}>Contact us for a personalized quote.</Link></p>
          </div>
            ...
            <table className="w-full border-collapse font-heading text-sm">
              <thead>
                <tr style={{ background: "#1a1a1a" }}>
                  ...
                  <th className="text-center p-4 font-bold" style={{ background: "#1f2937", color: "#EE6C13" }}>Grow</th>
                  <th className="text-center p-4 text-white font-semibold">Dominate</th>
                </tr>
              </thead>
              <tbody>
                {[
