...
export const services: ServiceData[] = [
  {
    ...
    heading: "SEO for Lawyers That Turns Rankings Into Signed Cases",
    ...
    faqs: [
      ...
      { question: "Is SEO for attorneys different from SEO for other businesses?", answer: "SEO for attorneys is fundamentally different from general business SEO because of three factors unique to legal. First, Google classifies legal content as YMYL, holding it to stricter E-E-A-T standards - your content needs verifiable attorney credentials and real legal expertise. Second, bar advertising ethics rules in every state restrict what you can claim in marketing materials, including online content. Third, legal keyword competition is among the most intense in any industry, with CPCs of $50-$300 reflecting the case values at stake. A generalist SEO agency that treats your law firm like a plumber or a dentist will consistently underperform a team that understands these distinctions." },
    ],
