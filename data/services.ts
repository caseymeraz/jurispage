...
export const services: ServiceData[] = [
  {
    ...
    process: [
      ...
      },
      {
        ...
        detail: "We restructure your practice area pages around the keywords and E-E-A-T (Experience, Expertise, Authoritativeness, and Trustworthiness) signals Google requires for YMYL legal content. That means attorney credentials visible above the fold, substantive content that demonstrates real legal knowledge, and title tags written to earn clicks over competitors, not generic descriptions that could belong to any firm in any state. We also optimize for entity recognition so Google and AI tools can clearly identify your attorneys, practice areas, and service locations as distinct, authoritative entities.",
      },
      {
