...
export const services: ServiceData[] = [
  {
    ...
    faqs: [
      ...
      { question: "Is SEO for attorneys different from SEO for other businesses?", answer: "Yes, and the differences are why generalist agencies consistently underperform in legal. Google holds legal content to YMYL standards that most industries never face — your content needs verifiable attorney credentials, not generic marketing copy. Bar advertising rules in every state restrict what you can claim, and violations carry real professional consequences. And legal keyword competition is among the most intense in any industry, with CPCs of $50-$300 reflecting the case values at stake. An agency that treats your firm like a dentist or a plumber will waste your money." },
      { question: "Why should I trust you when I'm pitched by a new agency every week?", answer: "You should not trust us based on a pitch. You should evaluate us the same way you evaluate opposing counsel — on the record. Ask us for client references in your practice area. Ask for specific examples of firms where we increased organic case volume and by how much. Ask to see a sample monthly report so you know exactly what deliverables and metrics you will receive. We publish our pricing, we do not require long-term contracts, and we will give you access to every tool and account we use on your behalf. If an agency will not do all of those things, that tells you what you need to know." },
    ...
    whyMatters: "Three numbers explain why law firm SEO is not optional.\n\nFirst, cost per case. Google Ads for legal keywords run $50-$300 per click. At a 5-8% conversion rate, that is $600-$6,000 per consultation request — and the leads stop when you stop paying. Our clients reach an average cost per organic case inquiry of $412 by month 12, and that number keeps dropping. Over three years, blended organic cost per case runs 60-75% lower than paid acquisition. You already understand compounding returns from your practice — SEO works the same way.\n\nSecond, the compounding advantage. SEO is the only marketing channel that builds equity instead of renting attention. Every page, link, and review makes the next ranking easier. The firms dominating your local results are not necessarily better lawyers — they started SEO earlier, and the gap compounds. A competitor cannot close that gap by simply outspending you on ads.\n\nThird, AI search is already sending referrals. Google AI Overviews appear on over 30% of legal searches. ChatGPT and Perplexity users are asking for lawyer recommendations by name and city. These tools pull from the same trust signals as traditional SEO — authoritative content, citations from credible sources, consistent entity information. Building real authority for traditional search automatically builds your visibility in AI search. Firms that ignore this are not just missing a new channel — they are ceding it to competitors who will be very difficult to displace later.",
    process: [
      {
        step: "Technical Audit",
        detail: "Google penalizes websites that are slow, broken, or confusing. Before we write a single word of content, we look under the hood to fix the technical roadblocks preventing your firm from being found. The audit covers broken links, duplicate title tags, blocked pages, slow-loading images, Core Web Vitals performance, and missing structured data markup (LegalService, attorney Person, FAQ, and LocalBusiness schema). You receive a prioritized fix list in plain English — what each issue is, what it is costing you, and how we fix it. You also get a baseline scorecard of your current organic traffic, keyword positions, and indexed pages so we can measure progress against concrete numbers, not vague promises.",
      },
      {
        step: "Keyword Research and Strategy",
        detail: "Not all search traffic is worth having. We separate the keywords that lead to signed retainers from the ones that attract law students writing papers. Using Ahrefs, Search Console, and Google Ads data, we map your practice areas and markets against search volume, keyword difficulty, and commercial intent. You receive the full keyword map with priority tiers and target pages before we publish anything. Nothing goes live without your approval, and every keyword we target has a clear line to case acquisition — not just traffic.",
      },
      {
        step: "On-Page Optimization",
        detail: "We restructure your practice area pages around the keywords and E-E-A-T signals Google requires for YMYL legal content. That means attorney credentials visible above the fold, substantive content that demonstrates real legal knowledge, and title tags written to earn clicks over competitors — not generic descriptions that could belong to any firm in any state. We also optimize for entity recognition so Google and AI tools can clearly identify your attorneys, practice areas, and service locations as distinct, authoritative entities.",
      },
      {
        step: "Content Publishing",
        detail: "We publish content targeting the exact questions your potential clients search — queries like 'what to do after a hit and run in Florida' or 'how much does a custody lawyer cost.' Each piece references specific state statutes, realistic timelines, and practical guidance because thin generic content does not rank in YMYL categories. We also build location-specific pages when you serve multiple markets and structure every piece for AI citation — clear factual claims and structured answers that LLMs can extract when responding to legal questions in your area.",
      },
      {
        step: "Link Building",
        detail: "We build backlinks from sources Google actually respects in legal: established directories like Avvo and Justia, bar association websites, local press placements, legal publications, and civic organizations in your market. Every placement is manually vetted. We do not use link farms, private blog networks, or paid link schemes. If a previous agency left toxic links in your profile, we audit and clean those up too. We also build citation-worthy content assets — original research and data-driven guides designed to earn links naturally and get cited by AI search tools.",
      },
      {
        step: "Google Business Profile Optimization",
        detail: "Your Google Business Profile determines whether your firm appears in the local 3-pack — the map listings that capture the top position for searches like '[practice area] lawyer near me.' We optimize your profile end to end: NAP consistency, category selection, service areas, weekly Google Posts, and a systematic review generation process built to comply with your state's specific bar advertising rules. Many firms do not realize that soliciting reviews with incentives or using language that implies guaranteed outcomes can trigger bar complaints. Our process maximizes review volume while keeping you in full compliance.",
      },
      {
        step: "Monthly Reporting",
        detail: "Your monthly report answers one question: is SEO generating cases? You see qualified leads generated, cost per lead, and cases signed — not 20 slides of keyword charts. You also see every link built, every page published, and every technical fix completed, with clear attribution to results. We track your visibility in AI search results too. If a tactic is not producing measurable movement after 90 days, we change the approach and explain why. You will never have to ask what you are paying for.",
      },
    ],
    stats: [
    ...
    signs: [
      "You searched for your own practice area and city on Google and you are not on the first page — even though you have been practicing in that market for years and have a stronger track record than the firms that are.",
      "You spent $8,000 on Google Ads last month, signed three cases, and realized that $2,600 per client is not sustainable — especially when your competitors seem to be getting the same quality leads from organic search without paying per click.",
      "Your website gets traffic, but the phone is not ringing. You have 1,000+ monthly visitors and fewer than 5 consultation requests because the traffic is informational browsers, not people ready to hire a lawyer.",
      "Your last agency sent monthly reports full of charts and jargon, but when you asked a simple question — how many phone calls came from organic search last month — they could not answer because they never set up the tracking.",
      "You paid for a website redesign and your traffic dropped. Nobody told you that changing URLs without redirects, removing content, or restructuring pages would destroy the rankings your old site had built.",
      "You asked ChatGPT to recommend a lawyer in your practice area and city. Your firm was not mentioned. A competitor with less experience was. AI search is already sending referrals, and you are invisible to it.",
      "You are getting impressions in Google Search Console but almost no clicks — which means potential clients are seeing your listing and choosing someone else, usually because your search result looks generic compared to competitors who have optimized their titles and descriptions.",
    ],
    extendedFaqs: [
      {
      ...
      },
      {
        ...
        answer: "Typically $2,000-$10,000+ per month depending on market, practice area, and competition. A solo family law attorney in a mid-size city: $2,000-$3,500. A personal injury firm in a top-20 metro: proportionally more. Our pricing is published — you can see exactly what is included without scheduling a call or sitting through a pitch. The real question is ROI: if a signed case generates $8,000 in fees and SEO brings in 5 new cases per month at maturity, the math is straightforward. We model this out with every prospective client during the initial consultation so you make the decision on numbers, not promises.",
      },
      {
        question: "How does AI search (ChatGPT, Perplexity, Google AI Overviews) affect law firm SEO?",
        answer: "AI search is the biggest shift in how people find lawyers since the local map pack. Google AI Overviews appear on 30%+ of legal queries. People are asking ChatGPT and Perplexity to recommend lawyers by practice area and city. These tools synthesize responses from authoritative web sources — the same signals that drive traditional SEO (quality content, authoritative backlinks, consistent entity data, structured markup) determine whether your firm gets mentioned. The difference: LLMs favor clear, factual, well-structured content and strong entity presence across multiple platforms. We optimize specifically for AI citation by structuring your content for extraction and ensuring your entity information is consistent across the web. This is not a separate service — it is how modern SEO should be done.",
      },
      {
