...
export const services: ServiceData[] = [
  {
    ...
    intro: "Law firm SEO is the practice of improving your website's visibility in Google's organic search results for the specific queries your potential clients type when they need legal help - searches like 'car accident attorney in Phoenix' or 'criminal defense lawyer free consultation near me.' Legal falls under Google's YMYL (Your Money or Your Life) category, meaning Google holds legal content to a higher standard of accuracy, authoritativeness, and trustworthiness than it applies to most industries. A shoe brand can recover from a thin content strategy; a law firm website that lacks real attorney credentials and substantive practice area pages will struggle to rank regardless of how much you spend on it. What separates a law firm SEO campaign that pays for itself from one that drains your budget is the ability to attract qualified traffic - people who actually need legal representation, not researchers, law students, or people two states away - and convert that traffic into signed clients.",
    features: [
    ...
    whyMatters: "Search engines drive 68% of all online experiences, and for legal services the stakes are high on both ends of the transaction - your potential client is often facing a crisis, and a single retained case can be worth $5,000 to $100,000+ to your firm. Google Ads for law firms can cost $50 to $300 per click in competitive markets like personal injury or criminal defense, which means a Google Ads-only strategy can push your cost per acquired client to $3,000-$8,000 or more. A well-ranked organic presence, by contrast, generates leads at a fraction of that cost once the investment matures - most firms we work with see their cost per organic case inquiry drop below $400 by month 12. Rankings also compound: a page that earns links and authority this year continues to generate calls next year, without you paying again for each click. Beyond the traditional blue-link results, Google's local 3-pack - the map results shown at the top of local searches - captures 44% of clicks on searches with local intent, and appearing there is driven by a combination of your Google Business Profile signals, local citation consistency, and the authority of your main website. Skipping SEO means voluntarily handing that traffic to the firms willing to invest in it.",
    process: [
      {
        step: "Technical Audit",
        detail: "We run a full crawl of your site using tools like Screaming Frog and Ahrefs to surface every issue Google sees before a human ever does - broken internal links, duplicate title tags, pages blocked by robots.txt, slow-loading images, and Core Web Vitals failures (LCP, CLS, INP). We also audit your schema markup: most law firm sites are missing LegalService schema, attorney Person schema, and FAQ schema, all of which give Google structured signals about who you are and what you do. The audit produces a prioritized fix list so you can see exactly what is wrong and why it matters, not just a PDF full of technical jargon.",
      },
      {
        step: "Keyword Research and Strategy",
        detail: "We map every practice area and city combination worth targeting against real search volume data, competitive difficulty scores, and estimated click-through rates - so you know which keywords bring in clients versus which ones attract researchers with no intention of hiring anyone. We distinguish between commercial-intent keywords ('divorce lawyer Chicago consultation'), informational keywords ('how long does a divorce take in Illinois'), and navigational searches, and we build a content strategy that covers all three because they feed different stages of the client decision process. You see the full keyword map before we publish a single page.",
      },
      {
        step: "On-Page Optimization",
        detail: "We rewrite or restructure your practice area pages around your target keywords, proper heading hierarchy (one H1, descriptive H2s and H3s), and the E-E-A-T signals Google requires for legal content - attorney credentials visible on the page, clear firm information, bar membership details, and structured content that demonstrates actual legal knowledge rather than generic descriptions. Every practice area page gets a properly formatted title tag, a compelling meta description written to earn clicks, internal links to related practice areas and blog content, and FAQ schema markup so your content can appear in Google's featured answer boxes.",
      },
      {
        step: "Content Publishing",
        detail: "We build a monthly content calendar targeting the questions your potential clients are typing into Google right now - things like 'what to do after a slip and fall in a store,' 'how much is a DUI lawyer,' and 'can I get custody if I have a criminal record.' Each piece is written by legal content specialists who understand the difference between content that ranks and content that also converts - thin, AI-generated articles that say nothing specific will not move the needle in a YMYL category. We also build out location-specific landing pages when you serve multiple cities, so a search for 'estate planning lawyer in Naperville' finds you, not just the Chicago-focused page.",
      },
      {
        step: "Link Building",
        detail: "We build backlinks from sources Google actually respects in the legal space: Avvo, Justia, FindLaw, and other established legal directory profiles; your state and local bar association websites; local press coverage and legal commentary placements; and industry publications relevant to your practice area. Every placement is manually vetted against Domain Authority, traffic, and topical relevance - we do not use link farms, private blog networks, or link swaps. For firms with existing link profiles, we also run a disavow audit to ensure old spammy links from previous agencies are not holding your domain back.",
      },
      {
        step: "Google Business Profile Optimization",
        detail: "Your Google Business Profile is the single most important factor in whether you appear in the local 3-pack, which captures the top position on map-intent searches in your city. We fully optimize your profile - NAP consistency, primary and secondary category selection, service area setup, weekly Google Posts, photo uploads, Q&A management, and a review generation process that complies with bar advertising rules in your state. We also audit your local citation consistency across directories like Yelp, Yellow Pages, and legal directories, because inconsistent name-address-phone data is a known local ranking suppressor.",
      },
      {
        step: "Monthly Reporting",
        detail: "Every month you receive a report that connects SEO work to business outcomes, not just graphs. You see which keywords moved, which pages are generating organic impressions and clicks in Google Search Console, and how many phone calls and form submissions are attributable to organic traffic via call tracking and GA4 goal completions. We show you the links we built, the pages we published, and the technical issues we fixed - so you always know what you paid for and whether it is working. If a tactic is not producing movement after 90 days, we change the approach and tell you why.",
      },
    ],
    stats: [
    ...
    signs: [
      "You search '[your city] personal injury lawyer' on Google and your competitors appear in the map pack with dozens of reviews, but your firm is nowhere on the first page - and you have been practicing in that city for years.",
      "Google Search Console shows you are getting impressions for your practice area keywords but your click-through rate is below 2%, which usually means your title tags and meta descriptions are written for lawyers, not for people in crisis at midnight looking for help.",
      "Your site gets 1,000 visits a month but generates fewer than 5 consultation requests - broad informational traffic with no purchase intent is inflating your numbers while the searches that actually convert go to your competitors.",
      "Your last SEO agency sent a 20-slide monthly deck showing 'keyword growth' and 'domain authority improvements,' but when you asked which pages generated the phone calls last month, they could not answer.",
      "You invested $15,000 in a new website 8 months ago and organic traffic is lower now than it was on your old site - a clear sign the redesign broke existing rankings and no one has fixed the technical fallout.",
      "A competing firm that opened two years ago and has half your case volume is outranking you for every core keyword in your market, which means they are investing in SEO and you are not - and that gap compounds every month.",
    ],
    extendedFaqs: [
      {
        question: "How long does law firm SEO take to show real results?",
        answer: "For most law firms, you will see measurable keyword movement in Google Search Console within 60-90 days of technical fixes and on-page optimization being completed. Meaningful lead flow from organic traffic - where you are consistently attributing 5-15 consultation requests per month to SEO - typically takes 6-12 months, depending on your market, how competitive your practice area is, and whether you are starting from scratch or have an existing site with some authority. Highly competitive markets like personal injury in major metros (New York, Los Angeles, Chicago) can take 12-18 months before organic displaces a meaningful share of your paid acquisition spend. We tell every new client to expect a 90-day technical foundation phase, a 3-6 month content and authority-building phase, and a compounding returns phase from month 9 onward. Firms that quit at month 4 because nothing visible is happening almost always bail right before the curve inflects.",
      },
      {
        question: "What is E-E-A-T and what does it actually require from a law firm website?",
        answer: "E-E-A-T stands for Experience, Expertise, Authoritativeness, and Trustworthiness - the framework Google's quality raters use to evaluate whether content on sensitive topics like legal advice deserves to rank. For law firm websites, the practical requirements include: attorney bio pages that list bar admission dates, state bars, law school, years of experience, and specific case types handled; content that is written or co-authored by a licensed attorney, not a general freelancer; a clearly listed physical address and phone number on every page; case results and client testimonials where your state bar ethics rules allow them; and external references to your firm from credible third-party sources like local bar associations, news outlets, or legal publications. A site that looks generic - with practice area descriptions that could belong to any firm and no verifiable attorney credentials - will be outranked by a less polished site that demonstrates real legal expertise and experience.",
      },
      {
        question: "What is the difference between law firm SEO and local SEO, and do I need both?",
        answer: "Organic law firm SEO and local SEO target different parts of the Google results page. Organic SEO improves your visibility in the traditional blue-link results, which cover a wider range of queries including informational ones ('what is comparative negligence'), broader geographic searches, and long-tail queries from people early in the research process. Local SEO specifically targets the map pack - the three business listings shown with a map pin and star ratings at the top of searches with local intent, like 'DUI attorney near me' or 'family lawyer in Denver.' The map pack gets approximately 44% of clicks on local searches and is driven by your Google Business Profile signals, the volume and recency of your Google reviews, NAP citation consistency across the web, and your website's overall domain authority. Both are essential for most law firms, and they reinforce each other - a strong website helps your map pack rankings, and a strong map pack presence drives branded searches that improve your organic performance.",
      },
      {
        question: "How many pages does a law firm website need for good SEO?",
        answer: "There is no single right number, but structure matters more than count. At minimum, a competitive law firm site needs one page per practice area (not a single Services page listing everything), one page per major city or region you serve, and an active blog publishing at least 2-4 substantive articles per month. A personal injury firm serving three metro areas with eight distinct practice areas needs roughly 40-60 pages of targeted content before it becomes genuinely competitive. A large litigation firm with 15+ practice areas and multi-state coverage might need 150-300 pages to cover the keyword surface area that matches its market position. Every page should target a specific, intentional keyword cluster and serve a real user need - not exist simply to add pages. Thin pages with 200 words of generic content actively hurt your rankings in a YMYL category.",
      },
      {
        question: "What do Google's YMYL standards mean for legal content specifically?",
        answer: "YMYL stands for 'Your Money or Your Life' - the class of content Google treats with stricter ranking standards because wrong information could cause real harm. Legal content is explicitly YMYL because someone relying on bad legal information could lose a case, miss a statute of limitations, sign a bad contract, or face criminal consequences. In practice, this means Google's algorithms and human quality raters look for signals that your content comes from a source with real legal credentials and real-world experience. Generic, surface-level practice area descriptions that could have been written by anyone do not satisfy these standards. Your content needs to reflect what an attorney actually knows - the specific statutes in your state, realistic timelines, what factors affect case value, common questions clients ask in consultations. Sites that publish this kind of substantive, attorney-informed content consistently outrank competitors who publish thin, keyword-stuffed pages, even if those competitors have been around longer.",
      },
      {
        question: "How do I evaluate whether my current SEO agency is actually performing?",
        answer: "Start with Google Search Console, which is free and available to anyone who owns the site. Log in and look at the Performance report for the past 6 months. Total clicks and total impressions should be trending upward if SEO work is being done correctly. If both lines are flat or declining, that is a concrete data point to bring to your agency. Second, ask for a deliverable log: a list of every page published, every link built, and every technical fix completed in the last 90 days with dates. A reputable agency can produce this in 10 minutes. If they cannot - or deflect to showing ranking positions without explaining what drove them - that is a red flag. Third, ask how many organic phone calls you received last month. This requires call tracking software like CallRail or a GA4 goal for phone click events. If your agency cannot answer that question, they have not set up the measurement infrastructure needed to actually manage your campaign to a result.",
      },
      {
        question: "Should I do SEO or Google Ads first for my law firm?",
        answer: "If your firm needs cases immediately and has budget, Google Ads can generate consultation requests within 48 hours of a well-structured campaign launching. SEO cannot do that. But Google Ads costs are ongoing - legal keywords run $50 to $200+ per click in competitive markets - so a Google Ads-only strategy can push your cost per acquired client to $3,000-$8,000 or more, and the leads stop the moment you stop paying. SEO takes 6-12 months to produce meaningful lead flow, but once it works, it generates cases at a fraction of that cost without the dependency on a daily ad spend. The most effective path for most growing firms is running Google Ads from day one for immediate revenue while SEO builds in the background, then gradually reducing ad spend as organic takes over. Firms that try to wait out the SEO ramp on zero marketing budget often cannot sustain the 12-month timeline without revenue to fund operations.",
      },
      {
        question: "How much does law firm SEO cost?",
        answer: "Law firm SEO ranges from $1,500 to $10,000+ per month depending on your market, practice area, and how aggressively you want to compete. A solo family law attorney in a mid-size city might see real results at $2,000-$3,500 per month. A personal injury firm competing in Los Angeles or New York against firms spending $50,000+ per month on marketing needs a meaningfully larger investment to move the needle. Our pricing is published on our pricing page - you can see what is included in each plan without scheduling a call first. The right starting point depends on your market competition level and what a retained client is worth to your practice. If an average signed case generates $8,000 in fees, you can absorb a higher monthly investment than a firm where average case value is $2,500.",
      },
    ],
    ...
    extendedFaqs: [
      {
        ...
        answer: "Law firm website design ranges from $3,000 for a basic WordPress site with a few practice area pages to $25,000 or more for a large multi-attorney firm with dozens of practice areas, multiple city pages, and full content writing included. The wide range comes down to page count, custom design complexity, and whether content writing is included. Our Launchpad plan delivers a professional WordPress site at a fixed published price with a 30-day guarantee. Grow and Dominate clients receive a full custom redesign as part of their ongoing engagement. Proprietary platforms from vendors like Scorpion or Martindale typically charge monthly fees indefinitely - and when you cancel, you lose the site. With WordPress, you own everything from day one.",
      },
      {
  ...
  },
  {
    ...
    extendedFaqs: [
      ...
      },
      {
        ...
        answer: "Launchpad is a foundation, not a long-term strategy. Most attorneys who open their firm with Launchpad move to a Grow or Dominate plan 6-12 months after launch once they have consistent case volume and cash flow. The Grow plan adds active SEO - link building, content publishing, technical monitoring - and optional paid advertising management. Because your Launchpad site is built on the same technical foundation as our larger plan sites, upgrading requires no rebuild. We layer more activity on top of what is already in place.",
      },
      {
