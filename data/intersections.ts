    ...
    faqs: [
      {
        ...
        answer:
          "A full custom website with dedicated practice area pages, case results section, attorney bios, and intake integration typically takes 8–12 weeks. We use a structured discovery, design, content, and launch process with defined milestones and your feedback incorporated at each stage.",
      },
      {
    ...
    tactics: [
      {
        ...
        body: "The hero section of a criminal defense site must be built for speed of comprehension and conversion. We design hero sections with a bold, empathetic headline, a 24/7 availability indicator, a click-to-call phone number visible above the fold, and a single primary CTA — no menu of options that forces a decision the visitor doesn't need to make.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "A competitive criminal defense content presence requires at minimum: a comprehensive main criminal defense page, 8–12 charge-specific pages, 3–5 process/procedure guides, and 10–15 FAQ articles. This foundation — roughly 25–35 pieces — can take 3–6 months to build properly. We prioritize content by search volume so the highest-opportunity pages are live first.",
      },
      {
...

  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "A complete family law firm website with practice area pages, attorney bios, a blog, consultation scheduling integration, and CRO-optimized design typically takes 8–12 weeks. Complex projects with multiple attorneys or locations may require additional time. We provide a detailed timeline at the start of every project.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "A strong DUI content foundation includes a comprehensive main DUI page, 4–6 charge-variation pages, a DMV hearing guide, a state law and penalties overview, and 10–15 FAQ articles covering common defendant questions. This core library — roughly 20–25 pieces — positions your site as a genuine resource and provides the content depth Google rewards with broader keyword visibility.",
      },
      {
