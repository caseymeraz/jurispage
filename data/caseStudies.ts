...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    type: "seo",
    heroStat: "+3,942% Increase in Website Traffic",
    stats: [
      { label: "Website Traffic Increase", value: "+3,942%" },
      { label: "Lead Inquiries", value: "3x" },
      { label: "Five-Star Reviews", value: "300+" },
      { label: "Client Recoveries", value: "$980M+" },
    ],
    challenge: "GJEL Accident Attorneys is an established 50+ year personal injury firm with strong case results but limited online visibility. Despite a DR of 51 and decades of courtroom success, the firm was not ranking for core San Jose PI keywords and relied heavily on referrals and traditional advertising to generate new case inquiries.",
    solution: "JurisPage executed a comprehensive SEO overhaul built around an injury-type keyword architecture with city-specific landing pages across the San Jose metro area. We optimized the firm's Google Business Profile, developed a content strategy that produced 900+ published pieces targeting high-intent PI queries, and built topical authority across every major injury category the firm handles.",
    results: "GJEL saw a 3,942% increase in organic website traffic. Lead inquiries tripled. The firm now ranks for 14,000+ keywords with 141 position-1 rankings in Google. Their review profile grew to 300+ five-star reviews, and the firm has recovered over $980 million for clients with a digital pipeline that consistently delivers qualified case inquiries.",
